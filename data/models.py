...
class Student(models.Model):
    ...
    religion = models.CharField(
        max_length=30, choices=RELIGION_CHOICES, default="other"
    )
    other_religion = models.CharField(
        max_length=30, blank=True
    )  # This is finally working can now be added inside the information of the students
    ...
    classroom = models.ForeignKey(
        Classroom, default=1, verbose_name="Classrooms", on_delete=models.SET_DEFAULT
    )
    ...
    father_name = models.CharField(
        max_length=120
    )  # this section is for the parents and guardian
    ...
    is_returnee_student = (("1", "Yes"), ("0", "No"))
    ...
    working_student = (("1", "Yes"), ("0", "No"))
    is_a_working_student = models.CharField(
        max_length=1, choices=working_student
    )  ######
    ...
    scholarship_program = (("1", "Yes"), ("0", "No"))
    is_a_four_ps_scholar = models.CharField(
        max_length=1, choices=scholarship_program
    )  # 4ps scholarship program ##########
    history = HistoricalRecords()
