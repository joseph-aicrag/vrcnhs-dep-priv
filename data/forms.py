...
class StudentForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        if self.instance.birthday:
            ...
            if today.month < self.instance.birthday.month or (
                today.month == self.instance.birthday.month
                and today.day < self.instance.birthday.day
            ):
                age -= 1
...
class TeacherForm(forms.ModelForm):
    ...
    group = forms.ChoiceField(
        choices=((1, "TEACHER"), (2, "ADMIN"), (3, "BOTH TEACHER AND ADMIN")),
        required=True,
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        if (
            ...
            and groups.filter(name="ADMIN").exists()
        ):
